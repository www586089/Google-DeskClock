...
public class SettingsActivity extends BaseActivity {
    ...
    public static class PrefsFragment extends PreferenceFragment
        ...
        private void refresh() {
            ...
            final int idx = weekStartPref.findIndexOfValue(value == null ? String.valueOf(Utils.DEFAULT_WEEK_START) : value);
        ...
        private void updateAutoSnoozeSummary(ListPreference listPref, String delay) {
            ...
            if (i == -1) {
                ...
                listPref.setSummary(Utils.getNumberFormattedQuantityString(getActivity(), R.plurals.auto_silence_summary, i));
            }
        }
