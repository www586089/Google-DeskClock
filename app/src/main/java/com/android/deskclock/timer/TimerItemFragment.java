...
public class TimerItemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TimerListItem v = (TimerListItem) inflater.inflate(R.layout.timer_list_item, null);
        mTimerObj.mView = v;
    ...
    private void onLabelPressed(TimerObj t) {
        ...
        final LabelDialogFragment newFragment = LabelDialogFragment.newInstance(t, t.mLabel, getParentFragment().getTag());
