...
public class DigitalAppWidgetProvider extends AppWidgetProvider {
    ...
    private void updateClock(
        ...
        final CharSequence dateFormat = Utils.isJBMR2OrLater()
                ? DateFormat.getBestDateTimePattern(Locale.getDefault(), context.getString(R.string.abbrev_wday_month_day_no_year))
                : ((SimpleDateFormat) SimpleDateFormat.getDateInstance(SimpleDateFormat.SHORT)).toPattern();
        ...
        widget.setPendingIntentTemplate(R.id.digital_appwidget_listview,
                PendingIntent.getActivity(context, 0, new Intent(context, CitiesActivity.class), 0));
